...
describe("EchoSpec", function () {
    ...
    it("Should be able to echo", function () {
        var out = Endpoint_1.default.performEcho('echo');
    ...
    it("Should be able to echo silence", function () {
        var out = Endpoint_1.default.performEcho('');
        Util_1.default.test(JSON.stringify(out));
        sanityCheck(out);
        chai_1.expect(out.code).to.equal(200);
    ...
    it("Should be able to handle a missing echo message sensibly", function () {
        var out = Endpoint_1.default.performEcho(undefined);
        Util_1.default.test(JSON.stringify(out));
        sanityCheck(out);
    ...
    it("Should be able to handle a null echo message sensibly", function () {
        var out = Endpoint_1.default.performEcho(null);
        Util_1.default.test(JSON.stringify(out));
        sanityCheck(out);
        chai_1.expect(out.code).to.equal(400);
