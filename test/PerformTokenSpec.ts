/**
 * Speical Unit tests for performQuery()
 *
...
describe("performQuery()", function () {
    ...
    it("2complex sort room with sum UP" ,function() {
        ...
        const expected: any = {"result":[{"rooms_furniture":"Classroom-Moveable Tablets","sumSeats":90,"avgSeats":90},{"rooms_furniture":"Classroom-Learn Lab","sumSeats":150,"avgSeats":50},{"rooms_furniture":"Classroom-Fixed Tables/Moveable Chairs","sumSeats":212,"avgSeats":70.67},{"rooms_furniture":"Classroom-Hybrid Furniture","sumSeats":381,"avgSeats":47.63},{"rooms_furniture":"Classroom-Moveable Tables & Chairs","sumSeats":506,"avgSeats":17.45},{"rooms_furniture":"Classroom-Movable Tablets","sumSeats":1516,"avgSeats":34.45},{"rooms_furniture":"Classroom-Fixed Tables/Fixed Chairs","sumSeats":1572,"avgSeats":157.2},{"rooms_furniture":"Classroom-Fixed Tables/Movable Chairs","sumSeats":6231,"avgSeats":91.63},{"rooms_furniture":"Classroom-Fixed Tablets","sumSeats":6332,"avgSeats":191.88},{"rooms_furniture":"Classroom-Movable Tables & Chairs","sumSeats":6479,"avgSeats":39.27}]};
        return new InsightFacade()
            .performQuery(query)
            .then(function (response: InsightResponse) {
                // pass
...
describe("performQuery()", function () {
    ...
    before(function (done) {
        this.timeout(10000);
        Log.test('Before: ' + (<any>this).test.parent.title);
        new InsightFacade().addDataset('courses', readZipFileSync('courses')).then(function () {
                done();
        });
    });
