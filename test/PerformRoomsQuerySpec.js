...
describe("performQuery()", function () {
    ...
    describe("rooms", function () {
        before(function (done) {
            this.timeout(4000);
            PersistenceLayer_1.default.getInstance().remove('rooms').then(function () {
                done();
            });
        });
    ...
    it("should be able to perform simple query", function () {
        ...
        var expected = { "result": [{ "rooms_name": "DMP_101", "rooms_type": "Small Group" }, { "rooms_name": "DMP_110", "rooms_type": "Tiered Large Group" }, { "rooms_name": "DMP_201", "rooms_type": "Small Group" }, { "rooms_name": "DMP_301", "rooms_type": "Tiered Large Group" }, { "rooms_name": "DMP_310", "rooms_type": "Tiered Large Group" }] };
        return new InsightFacade_1.default()
            .performQuery(simpleQuery)
            .then(function (response) {
            chai_1.expect(response.code).to.equal(200);
    ...
    it("should be able to handle a query which selects all courses", function () {
        ...
        return new InsightFacade_1.default()
            ...
            chai_1.expect(result.length).to.equal(364);
        })
            .catch(function (err) {
            chai_1.expect.fail();
        });
    ...
    it("SUM: sum rooms seats, order sumSeats", function () {
        ...
        var expected = { "result": [{ "rooms_furniture": "Classroom-Moveable Tablets", "sumSeats": 90 }, { "rooms_furniture": "Classroom-Learn Lab", "sumSeats": 150 }, { "rooms_furniture": "Classroom-Fixed Tables/Moveable Chairs", "sumSeats": 212 }, { "rooms_furniture": "Classroom-Hybrid Furniture", "sumSeats": 381 }, { "rooms_furniture": "Classroom-Moveable Tables & Chairs", "sumSeats": 506 }, { "rooms_furniture": "Classroom-Movable Tablets", "sumSeats": 1516 }, { "rooms_furniture": "Classroom-Fixed Tables/Fixed Chairs", "sumSeats": 1572 }, { "rooms_furniture": "Classroom-Fixed Tables/Movable Chairs", "sumSeats": 6231 }, { "rooms_furniture": "Classroom-Fixed Tablets", "sumSeats": 6332 }, { "rooms_furniture": "Classroom-Movable Tables & Chairs", "sumSeats": 6479 }] };
        return new InsightFacade_1.default()
            .performQuery(query)
            .then(function (response) {
            chai_1.expect(response.code).to.equal(200);
    ...
    it("SUM: twice sum rooms seats, order sumSeats", function () {
        ...
        var expected = { "result": [{ "rooms_type": "", "sumSeats": 60, "sumsSeats": 60 }, { "rooms_type": "Studio Lab", "sumSeats": 150, "sumsSeats": 150 }, { "rooms_type": "Active Learning", "sumSeats": 272, "sumsSeats": 272 }, { "rooms_type": "TBD", "sumSeats": 929, "sumsSeats": 929 }, { "rooms_type": "Case Style", "sumSeats": 1525, "sumsSeats": 1525 }, { "rooms_type": "Small Group", "sumSeats": 3752, "sumsSeats": 3752 }, { "rooms_type": "Open Design General Purpose", "sumSeats": 4475, "sumsSeats": 4475 }, { "rooms_type": "Tiered Large Group", "sumSeats": 12306, "sumsSeats": 12306 }] };
        return new InsightFacade_1.default()
            .performQuery(query)
            .then(function (response) {
            chai_1.expect(response.code).to.equal(200);
...
//# sourceMappingURL=PerformRoomsQuerySpec.js.map